...
var bob = {
    ...
    likes: fruit = ["apples", "bananas", "cherries"],
...
// #11 Write a function  called doubleTheFun that takes 1 parameter. It should double numbers, and repeats strings. example 4->8, 2.5->5, 'Awesome'->'AwesomeAwesome'
...
// #14 Create a function called coderTest that takes in an object that is a person. It looks to see if the person’s name is Jeremy and then add a new person object to have a property called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.  otherwise set lovesCode to 5.
...
function outside(temp, humd, cloud) {
    ...
    } else if (temp > 80 && humd < 40 && cloud < 20) {
        return "I'm literally in the desert";
    } else if (temp > 80 || humd > 50 || cloud > 50) {
